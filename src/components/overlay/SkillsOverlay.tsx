...
const SkillCard = ({
  ...
  const accentColor = isViolet
    ? "hsl(var(--neural-violet))"
    : "hsl(var(--neural-cyan))";
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          "linear-gradient(145deg, hsl(var(--cosmic-surface) / 0.9) 0%, hsl(var(--cosmic-deep) / 0.95) 100%)",
...
const SkillsOverlay = () => {
  ...
  return (
    <section
      id="skills"
      className="relative min-h-screen py-20 sm:py-32 px-4 sm:px-6 lg:px-12"
      ref={ref}
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 sm:mb-16">
          ...
          >
            ...
            <span className="font-mono text-xs sm:text-sm text-primary tracking-widest">
              02 / SKILLS
            </span>
          </motion.div>
          ...
          >
            Tech <span className="text-white">Arsenal</span>
          </motion.h2>
