    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 pb-32">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 mb-6 sm:mb-8 px-3 sm:px-4 py-2 border border-green-500/40 rounded-full"
        >
          <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
          <span className="text-xs sm:text-sm font-mono text-green-500">
        ...
        >
          <span className="text-foreground">KRRISH RASTOGI,</span>
          <br />
          <span className="text-white">building stuff that matters.</span>
        </motion.h1>
        ...
        >
          Passionate about creating complex backend systems and solving software
          level problems.
        </motion.p>
