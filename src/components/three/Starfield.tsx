...
const Starfield = ({ count = 2500, scrollProgress = 0 }: StarfieldProps) => {
  ...
  const geometry = useMemo(() => {
    ...
    geo.setAttribute('color', new THREE.InstancedBufferAttribute(instanceColors, 3));
    return geo;
  }, [instanceColors]);
